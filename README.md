...
Point layers have both buttons grayed out.
...
3. On the right end of the attribute-table toolbar you'll see the **Area** and **Length** buttons.
4. Click the appropriate one, choose a unit, click **OK**.
5. A new column appears in the attribute table.

## Field names

Auto-generated: `area_m2`, `area_km2`, `length_m`, `length_km`. If a name is already taken, `_2`, `_3`… is appended.
